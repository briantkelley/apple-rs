...
//! #     type Raw = ForeignType;
//! #
//! #     unsafe fn from_borrowed_ptr(ptr: core::ptr::NonNull<Self::Raw>) -> Arc<Self>
//! #     where
//! #         Self: Sized
//! #     { todo!() }
//! #
...
//! [`Box<T>`], which constructed using the [`from_owned_mut_ptr`] and [`try_from_owned_mut_ptr`]
...
//! [`from_borrowed_ptr`]: crate::ffi::ForeignFunctionInterface::from_borrowed_ptr
